...
metric_defaults = EasyDict([(args.name, args) for args in [
    ...
    EasyDict(name='tpl_huge',  func_name='metrics.traversal_perceptual_length.TPL',     n_samples_per_dim=193, crop=False, n_traversals=300, no_mapping=False, Gs_overrides=dict(dtype='float32', mapping_dtype='float32')),
