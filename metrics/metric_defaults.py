...
metric_defaults = EasyDict([(args.name, args) for args in [
    ...
    EasyDict(name='tpl_small_0.3',  func_name='metrics.traversal_perceptual_length.TPL',     n_samples_per_dim=25, crop=False, n_traversals=10, no_mapping=False, Gs_overrides=dict(dtype='float32', active_thresh=0.3, mapping_dtype='float32')),
    EasyDict(name='tpl_large_0.3',  func_name='metrics.traversal_perceptual_length.TPL',     n_samples_per_dim=49, crop=False, n_traversals=300, no_mapping=False, Gs_overrides=dict(dtype='float32', active_thresh=0.3, mapping_dtype='float32')),
